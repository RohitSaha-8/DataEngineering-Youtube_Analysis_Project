...
## @type: DataSource
## @args: [database = "de-on-yt-analysis-raw", table_name = "raw_statistics", transformation_ctx = "datasource0"]

predicate_pushdown = "region in ('ca','gb','us')"

datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "de-on-yt-analysis-raw", table_name = "raw_statistics", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://de-on-yt-analysis-cleaned-useast1-dev/youtube/raw_statistics/"}, format = "parquet", transformation_ctx = "datasink4"]

datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")

datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://de-on-yt-analysis-cleaned-useast1-dev/youtube/raw_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
